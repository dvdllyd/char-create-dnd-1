...
export class GeneratorService {
  ...
  races: string[]= [
    ...
    //'Alien',
    'Dragonborn', 'Dwarf', 'Elf', 'Gnome', 'Halfling', 'Half-Giant', 'Orc', 'Thri-Kreen', 'Tiefling',]
  race = new Subject
  ...
  classes: string[]= [
    'Barbarian', 'Crusader', 'Fighter', 'Monk', 'Paladin',
    'Adventurer', 'Assassin', 'Ranger',
    'Druid', 'Summoner', 'Warlock', 'Wild Mage', 'Wizard', 'Healer', 'Priest',
    'Psychic', ]
  class = new Subject
  ...
  armors: string[]= [
    'Light Armor (AC 12, MV 9)', 'Medium Armor (AC 14, MV 6)', 'Heavy Armor (AC 16, MV 3)',]
  armor = new Subject
